...
cvar_t		*draw_snap_y;
cvar_t		*draw_snap_h;
cvar_t		*draw_snap_auto;
cvar_t		*draw_snap_def;
cvar_t		*draw_snap_speed;
cvar_t		*draw_snap_rgba1;
cvar_t		*draw_snap_rgba2;
...
void HUD_DrawSnapping(float yaw) {
	...
	if (!draw_snap->integer) {
		return;
	}

	speed = draw_snap_speed->integer ? draw_snap_speed->integer : cl.snap.ps.speed;
	...
	switch (draw_snap_auto->integer) {
	case 0:
		yaw += draw_snap_def->value;
		break;
	case 1:
...
void SCR_Init( void ) {
	...
	draw_snap = Cvar_Get("draw_snap", "0", CVAR_ARCHIVE);
	draw_snap_rgba1 = Cvar_Get("draw_snap_rgba1", ".02 .1 .02 .4", CVAR_ARCHIVE);
	draw_snap_rgba2 = Cvar_Get("draw_snap_rgba2", ".05 .05 .05 .1", CVAR_ARCHIVE);
	draw_snap_y = Cvar_Get("draw_snap_y", "248", CVAR_ARCHIVE);
	draw_snap_h = Cvar_Get("draw_snap_h", "8", CVAR_ARCHIVE);
	draw_snap_auto = Cvar_Get("draw_snap_auto", "1", CVAR_ARCHIVE);
	draw_snap_def = Cvar_Get("draw_snap_def", "45", CVAR_ARCHIVE);
	draw_snap_speed = Cvar_Get("draw_snap_speed", "0", CVAR_ARCHIVE);
